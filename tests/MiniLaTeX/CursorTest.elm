...
suiteParseLoop =
    describe "the parseLoop function for MiniLaTeX"
        [ testParseLoopCommitted "(1)"
            ...
            , Expr "foo" [] { end = 8, id = "0.1", indent = 0, start = 4 }
            ]
        , testParseLoopCommitted "(2)"
            "\\foo{bar}"
            [ Expr "foo" [ Text "bar" { end = 8, id = "0.2", indent = 0, start = 5 } ] { end = 8, id = "0.0", indent = 0, start = 0 } ]
        ...
        , testParseLoopCommitted "(4)"
            "\\foo{\\bar{baz}}"
            [ Expr "foo" [ Expr "bar" [ Text "baz" { end = 13, id = "0.4", indent = 0, start = 10 } ] { end = 13, id = "0.2", indent = 0, start = 5 } ] { end = 13, id = "0.0", indent = 0, start = 0 } ]
        , testParseLoopCommitted "(5)"
            "very \\strong{bold} move"
            [ Text "very " { end = 5, id = "0.0", indent = 0, start = 0 }
            , Expr "strong" [ Text "bold" { end = 17, id = "0.3", indent = 0, start = 13 } ] { end = 17, id = "0.1", indent = 0, start = 5 }
        ...
        , testParseLoopCommitted
            "(8)"
            "$e^{ikx}$"
            [ Verbatim "$" "e^{ikx}" { end = 9, id = "0.0", indent = 0, start = 0 } ]
        ]
