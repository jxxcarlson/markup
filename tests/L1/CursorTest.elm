...
suiteParseLoop =
    describe "the parseLoop function for L1"
        ...
        , testParseLoopCommitted "(2)"
            ...
            , Expr "italic" [ Text "italic " { end = 17, id = "0.2", indent = 0, start = 11 } ] { end = 11, id = "0.1", indent = 0, start = 8 }
            ]
        ...
        , testParseLoopCommitted "(4)"
            "[b [red flowers]]"
            [ Expr "strong" [ Expr "red" [ Text "flowers " { end = 15, id = "0.2", indent = 0, start = 8 } ] { end = 15, id = "0.1", indent = 0, start = 3 } ] { end = 15, id = "0.0", indent = 0, start = 0 } ]
        ...
        , testParseLoopCommitted "(6)"
            ...
            [ Expr "italic"
                ...
                , Expr "strong" [ Text "BBB " { end = 13, id = "0.3", indent = 0, start = 10 } ] { end = 13, id = "0.2", indent = 0, start = 7 }
                ]
        ...
        , testParseLoopCommitted "(7)"
            ...
            [ Expr "italic"
                ...
                , Expr "strong" [ Text "tall " { end = 25, id = "0.3", indent = 0, start = 21 } ] { end = 25, id = "0.2", indent = 0, start = 18 }
                ]
        ...
        , testParseLoopCommitted "(10)"
            "[link ABC DEF] GHI"
            [ Expr "link" [ Text "ABC " { end = 13, id = "0.1", indent = 0, start = 6 }, Text "DEF " { end = 13, id = "0.1", indent = 0, start = 6 } ] { end = 6, id = "0.0", indent = 0, start = 0 }
            , Text " " { end = 0, id = "1.2", indent = 0, start = 0 }
